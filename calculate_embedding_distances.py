...
def generate_word_embedding_dict(words,inputs,labels):
    word_embedding_dict = {}
...
if __name__ == '__main__':
	...
	word_embedding_dict = generate_word_embedding_dict(words,inputs,labels)

	print('Calculated the embeddings')
