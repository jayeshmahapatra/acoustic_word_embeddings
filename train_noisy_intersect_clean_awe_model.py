...
if __name__ == '__main__':
	...
	hist = train_model(net,num_epochs,train_dl,val_dl,optimizer,criterion,dev,save_path="/data/users/jmahapatra/models/noisy_intersect_clean/",verbose = True)
	#hist = train_model(net,num_epochs,train_dl,val_dl,optimizer,criterion,dev,save_path="./Models/test/",verbose = True)
	
	plot_learning_curves(hist,'/data/users/jmahapatra/data/noisy_intersect_clean_learning_curves.png', show = False)
